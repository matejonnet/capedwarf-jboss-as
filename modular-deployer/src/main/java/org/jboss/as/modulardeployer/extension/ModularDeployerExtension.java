 ...
 */
public class ModularDeployerExtension implements Extension {
     ...
     */
    public static final String SUBSYSTEM_NAME = "modular-deployer";

    private static final String RESOURCE_NAME = ModularDeployerExtension.class.getPackage().getName() + ".LocalDescriptions";
